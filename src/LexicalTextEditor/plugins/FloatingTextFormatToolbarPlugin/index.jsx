    ...
    <div ref={popupCharStylesEditorRef} className="floating-text-format-popup">
      {editor.isEditable() && (
        <>
          ...
          >
            <Icon icon={Italic} className="icon" />
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
            <Icon icon={Underline} className="icon" />
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
            <Icon icon={Strikethrough} className="icon" />
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
            <Icon icon={Subscript} className="icon" />
          </button>
          <button
            type="button"
            onClick={() => {
          ...
          >
            <Icon icon={Superscript} className="icon" />
          </button>
          <button
            type="button"
            onClick={() => {
